 ...
 */
export declare function convertToTWError(error: any, network: ethers.providers.Network, signerAddress: string, contractAddress: string, contractInterface: ethers.utils.Interface): Promise<TransactionError>;
/**
 * @internal
 * @param err
 * @param message
