 ...
 * @param gatewayUrl
 */
export declare function replaceGatewayUrlWithHash(object: Record<string, any>, scheme: string, gatewayUrl: string): Record<string, any>;
/**
 ...
 * @param gatewayUrl
 */
export declare function resolveGatewayUrl<T extends Json>(object: T, scheme: string, gatewayUrl: string): T;
/**
 * @internal
 * @param object
 * @param scheme
 * @param gatewayUrl
 */
export declare function toIPFSHash<T extends Json>(object: T, scheme: string, gatewayUrl: string): T;
