...
export interface DropERC1155 extends BaseContract {
    ...
    functions: {
        ...
        setClaimConditions(_tokenId: BigNumberish, _phases: IDropClaimCondition.ClaimConditionStruct[], _resetClaimEligibility: boolean, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    contractVersion(overrides?: CallOverrides): Promise<number>;
    getActiveClaimConditionId(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    getClaimConditionById(_tokenId: BigNumberish, _conditionId: BigNumberish, overrides?: CallOverrides): Promise<IDropClaimCondition.ClaimConditionStructOutput>;
    getClaimTimestamp(_tokenId: BigNumberish, _conditionId: BigNumberish, _claimer: string, overrides?: CallOverrides): Promise<[
        BigNumber,
        BigNumber
    ] & {
    ...
    callStatic: {
        ...
        setClaimConditions(_tokenId: BigNumberish, _phases: IDropClaimCondition.ClaimConditionStruct[], _resetClaimEligibility: boolean, overrides?: CallOverrides): Promise<void>;
