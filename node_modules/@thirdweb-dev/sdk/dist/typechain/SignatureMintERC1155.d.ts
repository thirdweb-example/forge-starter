...
export interface SignatureMintERC1155Interface extends utils.Interface {
    functions: {
...
export interface SignatureMintERC1155 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SignatureMintERC1155Interface;
