...
export interface ERC721SignatureMintInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "balanceOf" | "batchMintTo" | "burn" | "contractURI" | "getApproved" | "getBaseURICount" | "getBatchIdAtIndex" | "getDefaultRoyaltyInfo" | "getRoyaltyInfoForToken" | "isApprovedForAll" | "mintTo" | "mintWithSignature" | "multicall" | "name" | "nextTokenIdToMint" | "owner" | "ownerOf" | "primarySaleRecipient" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setPrimarySaleRecipient" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply" | "transferFrom" | "verify"): FunctionFragment;
...
export interface ERC721SignatureMint extends BaseContract {
    ...
    functions: {
        ...
        batchMintTo(_to: string, _quantity: BigNumberish, _baseURI: string, _data: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        mintTo(_to: string, _tokenURI: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        balanceOf(owner: string, overrides?: CallOverrides): Promise<BigNumber>;
        batchMintTo(_to: string, _quantity: BigNumberish, _baseURI: string, _data: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        getRoyaltyInfoForToken(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string, number]>;
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        mintTo(_to: string, _tokenURI: string, overrides?: CallOverrides): Promise<void>;
