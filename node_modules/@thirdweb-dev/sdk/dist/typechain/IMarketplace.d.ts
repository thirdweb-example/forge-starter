...
export interface IMarketplaceInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptOffer" | "buy" | "cancelDirectListing" | "closeAuction" | "contractType" | "contractURI" | "contractVersion" | "createListing" | "getPlatformFeeInfo" | "offer" | "setContractURI" | "setPlatformFeeInfo" | "updateListing"): FunctionFragment;
...
export declare type ListingAddedEvent = TypedEvent<[
    BigNumber,
    string,
    string,
    IMarketplace.ListingStructOutput
], ListingAddedEventObject>;
export declare type ListingAddedEventFilter = TypedEventFilter<ListingAddedEvent>;
export interface ListingRemovedEventObject {
    listingId: BigNumber;
    listingCreator: string;
}
export declare type ListingRemovedEvent = TypedEvent<[
    BigNumber,
    string
], ListingRemovedEventObject>;
export declare type ListingRemovedEventFilter = TypedEventFilter<ListingRemovedEvent>;
export interface ListingUpdatedEventObject {
    listingId: BigNumber;
    listingCreator: string;
}
export declare type ListingUpdatedEvent = TypedEvent<[
    BigNumber,
    string
], ListingUpdatedEventObject>;
export declare type ListingUpdatedEventFilter = TypedEventFilter<ListingUpdatedEvent>;
