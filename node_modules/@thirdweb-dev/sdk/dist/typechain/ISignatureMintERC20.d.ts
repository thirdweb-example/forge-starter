...
export interface ISignatureMintERC20Interface extends utils.Interface {
    functions: {
...
export interface ISignatureMintERC20 extends BaseContract {
    ...
    functions: {
        ...
        verify(req: ISignatureMintERC20.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            signer: string;
        }>;
    };
    ...
    estimateGas: {
        ...
        verify(req: ISignatureMintERC20.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        mintWithSignature(req: ISignatureMintERC20.MintRequestStruct, signature: BytesLike, overrides?: PayableOverrides & {
            from?: string | Promise<string>;
        }): Promise<PopulatedTransaction>;
        verify(req: ISignatureMintERC20.MintRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
