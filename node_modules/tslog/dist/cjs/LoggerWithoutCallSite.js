...
class LoggerWithoutCallSite {
    ...
    constructor(settings, parentSettings) {
        ...
        this._parentOrDefaultSettings = {
            ...
            hostname: (_a = parentSettings === null || parentSettings === void 0 ? void 0 : parentSettings.hostname) !== null && _a !== void 0 ? _a : (0, os_1.hostname)(),
            name: undefined,
    ...
    setSettings(settings, parentSettings) {
        ...
        this._mySettings.name =
            (_d = this._mySettings.name) !== null && _d !== void 0 ? _d : (this._mySettings.setCallerAsLoggerName
                ? (_k = (_g = (_f = (_e = LoggerHelper_1.LoggerHelper.getCallSites()) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.getTypeName()) !== null && _g !== void 0 ? _g : (_j = (_h = LoggerHelper_1.LoggerHelper.getCallSites()) === null || _h === void 0 ? void 0 : _h[0]) === null || _j === void 0 ? void 0 : _j.getFunctionName()) !== null && _k !== void 0 ? _k : undefined
                : undefined);
    ...
    printPrettyLog(std, logObject) {
        ...
        if (this.settings.displayLogLevel) {
            ...
            std.write(LoggerHelper_1.LoggerHelper.styleString([colorName, "bold"], logObject.logLevel.toUpperCase(), this.settings.colorizePrettyLogs) +
    ...
    _printPrettyStack(std, stackObjectArray) {
        ...
        Object.values(stackObjectArray).forEach((stackObject) => {
            ...
            if (stackObject.filePath != null &&
                ...
                std.write("\n    ");
                std.write((0, path_1.normalize)(LoggerHelper_1.LoggerHelper.styleString(["gray"], `${stackObject.filePath}:${stackObject.lineNumber}:${stackObject.columnNumber}`, this.settings.colorizePrettyLogs)));
            }
            std.write("\n\n");
        });
    }
    ...
    _inspectAndHideSensitive(object, inspectOptions) {
        ...
        try {
            ...
            formatted = (0, util_1.inspect)(maskedObject, inspectOptions);
        }
        catch {
            formatted = (0, util_1.inspect)(object, inspectOptions);
        }
        return this._maskAny(formatted);
    }
    _formatAndHideSensitive(formatParam, inspectOptions, ...param) {
        return this._maskAny((0, util_1.formatWithOptions)(inspectOptions, formatParam, ...param));
    }
